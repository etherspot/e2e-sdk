...
let BscUSDT = "0x524bC91Dc82d6b90EF29F76A3ECAaBAffFD490Bc"; // Bsc - USDT
...
describe("The SDK, when swap the token with different features on the MainNet", () => {
  it("SMOKE: Perform the single chain swap action on the bsc network", async () => {
    ...
    try {
      offers = await bscMainNetSdk.getExchangeOffers({
        fromTokenAddress: BscUSDC, // USDC Token
        toTokenAddress: BscUSDT, // USDT Token
  ...
  it("SMOKE: Perform the cross chain quote action on the bsc network", async () => {
    // initialize the sdk
    try {
      bscMainNetSdk = new Sdk(process.env.PRIVATE_KEY, {
        env: EnvNames.MainNets,
  ...
  it("REGRESSION: Perform the single chain swap action from ERC20 token to Native Token on the bsc network", async () => {
    let offers;
    let transactionDetails;
    let TransactionData_count = 0;
    // Initialize the SDK and define network
  ...
  it("REGRESSION: Perform the single chain swap action from Native Token to ERC20 token on the bsc network", async () => {
    // Initialize the SDK and define network
    try {
      bscMainNetSdk = new Sdk(process.env.PRIVATE_KEY, {
        env: EnvNames.MainNets,
  ...
  it("REGRESSION: Perform the single chain swap action without estimation of the batch on the bsc network", async () => {
    let transactionDetails;
    // Initialize the SDK and define network
    try {
      bscMainNetSdk = new Sdk(process.env.PRIVATE_KEY, {
  ...
  it("REGRESSION: Perform the single chain swap action from ERC20 token to ERC20 Token with exceed token balance on the bsc network", async () => {
    // Initialize the SDK and define network
    try {
      bscMainNetSdk = new Sdk(process.env.PRIVATE_KEY, {
        env: EnvNames.MainNets,
  ...
  it("REGRESSION: Perform the single chain swap action from ERC20 token to native token with exceed token balance on the bsc network", async () => {
    // Initialize the SDK and define network
    try {
      bscMainNetSdk = new Sdk(process.env.PRIVATE_KEY, {
        env: EnvNames.MainNets,
  ...
  it("REGRESSION: Perform the single chain swap action from ERC20 token to the same ERC20 token on the bsc network", async () => {
    try {
      bscMainNetSdk = new Sdk(process.env.PRIVATE_KEY, {
        env: EnvNames.MainNets,
        networkName: NetworkNames.Bsc,
    ...
    try {
      try {
        await bscMainNetSdk.getExchangeOffers({
          fromTokenAddress: BscUSDC, // USDC Token
          toTokenAddress: BscUSDC, // Both are Same USDC Tokens
          fromAmount: ethers.utils.parseUnits("0.0001", 6),
        });
        assert.fail(
  ...
  it("REGRESSION: Perform the single chain swap action without toTokenAddress value while get the exchange offers on the bsc network", async () => {
    // Initialize the SDK and define network
    try {
      bscMainNetSdk = new Sdk(process.env.PRIVATE_KEY, {
        env: EnvNames.MainNets,
  ...
  it("REGRESSION: Perform the single chain swap action without fromTokenAddress value while get the exchange offers on the bsc network", async () => {
    // Initialize the SDK and define network
    try {
      bscMainNetSdk = new Sdk(process.env.PRIVATE_KEY, {
        env: EnvNames.MainNets,
  ...
  it("REGRESSION: Perform the single chain swap action without fromAmount value while get the exchange offers on the bsc network", async () => {
    // Initialize the SDK and define network
    try {
      bscMainNetSdk = new Sdk(process.env.PRIVATE_KEY, {
        env: EnvNames.MainNets,
  ...
  it("REGRESSION: Perform the single chain swap action with invalid toTokenAddress value while get the exchange offers on the bsc network", async () => {
    // Initialize the SDK and define network
    try {
      bscMainNetSdk = new Sdk(process.env.PRIVATE_KEY, {
        env: EnvNames.MainNets,
  ...
  it("REGRESSION: Perform the single chain swap action with invalid fromTokenAddress value while get the exchange offers on the bsc network", async () => {
    // Initialize the SDK and define network
    try {
      bscMainNetSdk = new Sdk(process.env.PRIVATE_KEY, {
        env: EnvNames.MainNets,
  ...
  it("REGRESSION: Perform the cross chain quote action without fromChainId value in the quote request payload on the bsc network", async () => {
    try {
      // initialize the sdk
      bscMainNetSdk = new Sdk(process.env.PRIVATE_KEY, {
        env: EnvNames.MainNets,
  ...
  it("REGRESSION: Perform the cross chain quote action without toChainId value in the quote request payload on the bsc network", async () => {
    try {
      // initialize the sdk
      bscMainNetSdk = new Sdk(process.env.PRIVATE_KEY, {
        env: EnvNames.MainNets,
  ...
  it("REGRESSION: Perform the cross chain quote action without fromTokenAddress value in the quote request payload on the bsc network", async () => {
    try {
      // initialize the sdk
      bscMainNetSdk = new Sdk(process.env.PRIVATE_KEY, {
        env: EnvNames.MainNets,
  ...
  it("REGRESSION: Perform the cross chain quote action without toTokenAddress value in the quote request payload on the bsc network", async () => {
    try {
      // initialize the sdk
      bscMainNetSdk = new Sdk(process.env.PRIVATE_KEY, {
        env: EnvNames.MainNets,
  ...
  it("REGRESSION: Perform the cross chain quote action without fromAmount value in the quote request payload on the bsc network", async () => {
    try {
      // initialize the sdk
      bscMainNetSdk = new Sdk(process.env.PRIVATE_KEY, {
        env: EnvNames.MainNets,
  ...
  it("REGRESSION: Perform the cross chain quote action from native token to another chain's ERC20 token in the quote request payload on the bsc network", async () => {
    ...
    // Get the cross chain quotes
    try {
      let quotes = await bscMainNetSdk.getCrossChainQuotes(quoteRequestPayload);
  ...
  it("REGRESSION: Perform the cross chain quote action with the same ERC20 tokens in the quote request payload on the bsc network", async () => {
    try {
      // initialize the sdk
      bscMainNetSdk = new Sdk(process.env.PRIVATE_KEY, {
        env: EnvNames.MainNets,
    ...
    let fromChainId = NETWORK_NAME_TO_CHAIN_ID[NetworkNames.Bsc];
    let toChainId = NETWORK_NAME_TO_CHAIN_ID[NetworkNames.Xdai];
    let fromTokenAddress = BscUSDC; // Bsc - USDC
    let toTokenAddress = BscUSDC; // Bsc - USDC
    let fromAmount = ethers.utils.parseUnits("0.5", 6);
  ...
  it("REGRESSION: Perform the cross chain quote action with exceeded token balance in the quote request payload on the bsc network", async () => {
    try {
      // initialize the sdk
      bscMainNetSdk = new Sdk(process.env.PRIVATE_KEY, {
        env: EnvNames.MainNets,
  ...
  it("REGRESSION: Perform the cross chain quote action with low token balance in the quote request payload on the bsc network", async () => {
    try {
      // initialize the sdk
      bscMainNetSdk = new Sdk(process.env.PRIVATE_KEY, {
        env: EnvNames.MainNets,
  ...
  it("REGRESSION: Perform the cross chain quote action without estimation of the batch on the bsc network", async () => {
    try {
      // initialize the sdk
      bscMainNetSdk = new Sdk(process.env.PRIVATE_KEY, {
        env: EnvNames.MainNets,
  ...
  it("REGRESSION: Perform the cross chain quote action with invalid tokenAddress of the approval transaction request on the bsc network", async () => {
    try {
      // initialize the sdk
      bscMainNetSdk = new Sdk(process.env.PRIVATE_KEY, {
        env: EnvNames.MainNets,
  ...
  it("REGRESSION: Perform the cross chain quote action with invalid approvalAddress of the approval transaction request on the bsc network", async () => {
    try {
      // initialize the sdk
      bscMainNetSdk = new Sdk(process.env.PRIVATE_KEY, {
        env: EnvNames.MainNets,
  ...
  it("REGRESSION: Perform the cross chain quote action with invalid amount of the approval transaction request on the bsc network", async () => {
    try {
      // initialize the sdk
      bscMainNetSdk = new Sdk(process.env.PRIVATE_KEY, {
        env: EnvNames.MainNets,
  ...
  it("REGRESSION: Perform the cross chain quote action with invalid To Address of the approval transaction payload on the bsc network", async () => {
    try {
      // initialize the sdk
      bscMainNetSdk = new Sdk(process.env.PRIVATE_KEY, {
        env: EnvNames.MainNets,
  ...
  it("REGRESSION: Perform the advance route lifi action from ERC20 token to another chain's native token in the quote request payload on the bsc network", async () => {
    try {
      // initialize the sdk
      bscMainNetSdk = new Sdk(process.env.PRIVATE_KEY, {
        env: EnvNames.MainNets,
  ...
  it("REGRESSION: Perform the advance route lifi action with exceeded token balance in the quote request payload on the bsc network", async () => {
    try {
      // initialize the sdk
      bscMainNetSdk = new Sdk(process.env.PRIVATE_KEY, {
        env: EnvNames.MainNets,
  ...
  it("REGRESSION: Perform the advance route lifi action without estimation of the batch on the bsc network", async () => {
    try {
      // initialize the sdk
      bscMainNetSdk = new Sdk(process.env.PRIVATE_KEY, {
        env: EnvNames.MainNets,
