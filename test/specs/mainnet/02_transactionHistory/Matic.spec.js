...
describe('Get the transaction history with matic network on the MainNet', () => {
  ...
  it('SMOKE: Perform the send native token on the matic network and get the transaction history', async () => {
    if (runTest) {
  ...
  it('REGRESSION: Perform the send native token on the matic network and get the transaction history from the random hash', async () => {
    if (runTest) {
      // Fetching historical transactions
      let transactions;
  ...
  it('REGRESSION: Perform the send native token on the matic network and get the transaction history with incorrect hash', async () => {
    if (runTest) {
      // Fetching a single transaction
      try {
  ...
  it('REGRESSION: Perform the send native token on the matic network and get the transaction history when hash hex is not with 32 size', async () => {
    if (runTest) {
      // Fetching a single transaction
      try {
        try {
