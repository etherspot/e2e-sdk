...
describe("The SDK, when sending a native token with optimism network on the MainNet", () => {
  ...
  it("REGRESSION: Setup the SDK for optimism network and perform the send native token with invalid to address", async () => {
    // initialize the sdk
    try {
      optimismMainNetSdk = new Sdk(process.env.PRIVATE_KEY, {
        env: EnvNames.MainNets,
    ...
    // Compute the smart wallet address
    try {
      let smartWalletOutput = await optimismMainNetSdk.computeContractAccount();
      let optimismSmartWalletAddress = smartWalletOutput.address;
  ...
  it("REGRESSION: Setup the SDK for optimism network and perform the send native token with invalid value", async () => {
    // initialize the sdk
    try {
      optimismMainNetSdk = new Sdk(process.env.PRIVATE_KEY, {
        env: EnvNames.MainNets,
  ...
  it("REGRESSION: Setup the SDK for optimism network and perform the send native token with exceeded value.", async () => {
    // initialize the sdk
    try {
      optimismMainNetSdk = new Sdk(process.env.PRIVATE_KEY, {
        env: EnvNames.MainNets,
  ...
  it("REGRESSION: Setup the SDK for optimism network and perform the send native token on the same address", async () => {
    // initialize the sdk
    try {
      optimismMainNetSdk = new Sdk(process.env.PRIVATE_KEY, {
        env: EnvNames.MainNets,
  ...
  it("REGRESSION: Setup the SDK for optimism network and perform the send native token without estimation of the batch", async () => {
    // initialize the sdk
    try {
      optimismMainNetSdk = new Sdk(process.env.PRIVATE_KEY, {
        env: EnvNames.MainNets,
