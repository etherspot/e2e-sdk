...
describe('The SDK, when sending a native token with arbitrum network on the MainNet', function () {
  ...
  it('SMOKE: Perform the send native token on the arbitrum network', async function () {
    var test = this;
    if (runTest) {
  ...
  it.only('REGRESSION: Perform the send native token with invalid to address on the arbitrum network', async function () {
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Perform the send native token with invalid value on the arbitrum network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Perform the send native token with exceeded value on the arbitrum network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Perform the send native token on the same address on the arbitrum network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Perform the send native token without estimation of the batch on the arbitrum network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
