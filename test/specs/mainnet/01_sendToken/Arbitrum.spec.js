...
describe("The SDK, when sending a native token with arbitrum network on the MainNet", () => {
  ...
  it("REGRESSION: Perform the send native token with invalid to address on the arbitrum network", async () => {
    if (runTest) {
  ...
  it("REGRESSION: Perform the send native token with invalid value on the arbitrum network", async () => {
    if (runTest) {
  ...
  it("REGRESSION: Perform the send native token with exceeded value on the arbitrum network", async () => {
    if (runTest) {
  ...
  it("REGRESSION: Perform the send native token on the same address on the arbitrum network", async () => {
    if (runTest) {
  ...
  it("REGRESSION: Perform the send native token without estimation of the batch on the arbitrum network", async () => {
    if (runTest) {
