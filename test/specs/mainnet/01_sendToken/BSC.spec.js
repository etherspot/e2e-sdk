...
describe('The SDK, when sending a native token with bsc network on the MainNet', function () {
  ...
  it('SMOKE: Perform the send native token on the bsc network', async function () {
    var test = this;
    if (runTest) {
  ...
  it('REGRESSION: Perform the send native token with invalid to address on the bsc network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Perform the send native token with invalid value on the bsc network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Perform the send native token with exceeded value on the bsc network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Perform the send native token on the same address on the bsc network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
  ...
  it('REGRESSION: Perform the send native token without estimation of the batch on the bsc network', async function () {
    var test = this;
    if (runTest) {
      await customRetryAsync(async function () {
