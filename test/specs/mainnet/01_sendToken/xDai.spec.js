...
describe("The SDK, when sending a native token with xdai network on the MainNet", () => {
  ...
  it("REGRESSION: Perform the send native token with invalid to address on the xdai network", async () => {
    if (runTest) {
  ...
  it("REGRESSION: Perform the send native token with invalid value on the xdai network", async () => {
    if (runTest) {
  ...
  it("REGRESSION: Perform the send native token with exceeded value. on the xdai network", async () => {
    if (runTest) {
  ...
  it("REGRESSION: Perform the send native token on the same address on the xdai network", async () => {
    if (runTest) {
  ...
  it("REGRESSION: Perform the send native token without estimation of the batch on the xdai network", async () => {
    if (runTest) {
